...
public class Ejercicio12 {
	...
	public static void main (String[]args) {
		...
		while(!jugador.equalsIgnoreCase("S")) {
			...
			if(jugador.equalsIgnoreCase(maquina)) {System.out.println("Empate");
			continue;}
			...
			else {System.out.println("Error. Por favor, introduce un valor válido");}
		...
		if (contadorUsuario > contadorMaquina) {System.out.println("Enhorabuena, has ganado");}
		else {System.out.println("Oh vaya, has perdido contra los robots");}
